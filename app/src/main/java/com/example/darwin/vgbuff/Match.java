...
public class Match {
    ...
    public void getMatchesDetailType(String user, String dataRaw, String matchType){
        ...
        try {
            ...
            for (allMatchCount = 0; allMatchCount < matchesArr.length(); allMatchCount++){

                if (matchesArr.getJSONObject(allMatchCount).getJSONObject("attributes").getString("gameMode").toUpperCase().equals(matchType)) {
                    matchTypeCount++;
                    pos.add(allMatchCount);
                }

            }

            Log.i("MATCHTYPE",String.valueOf(matchTypeCount));

            // Initialize array
            matchID = new String[matchTypeCount];
            rawCreatedAt = new String[matchTypeCount];
            duration = new int[matchTypeCount];
            rawGameMode = new String[matchTypeCount];
            endGameReason = new String[matchTypeCount];
            rosterID1 = new String[matchTypeCount];
            rosterID2 = new String[matchTypeCount];
            ace1 =  new int[matchTypeCount];
            gold1 = new int[matchTypeCount];
            heroKills1 = new int[matchTypeCount];
            kraken1 = new int[matchTypeCount];
            side1 = new String[matchTypeCount];
            turretKills1 = new int[matchTypeCount];
            turretRemaining1 = new int[matchTypeCount];
            roster1player1 = new String[matchTypeCount];
            roster1player2 = new String[matchTypeCount];
            roster1player3 = new String[matchTypeCount];
            roster1player1Name = new String[matchTypeCount];
            roster1player2Name = new String[matchTypeCount];
            roster1player3Name = new String[matchTypeCount];
            ace2 =  new int[matchTypeCount];
            gold2 = new int[matchTypeCount];
            heroKills2 = new int[matchTypeCount];
            kraken2 = new int[matchTypeCount];
            side2 = new String[matchTypeCount];
            turretKills2 = new int[matchTypeCount];
            turretRemaining2 = new int[matchTypeCount];
            roster2player1 = new String[matchTypeCount];
            roster2player2 = new String[matchTypeCount];
            roster2player3 = new String[matchTypeCount];
            roster2player1Name = new String[matchTypeCount];
            roster2player2Name = new String[matchTypeCount];
            roster2player3Name = new String[matchTypeCount];
            roster1player1User = new String[matchTypeCount];
            roster1player2User = new String[matchTypeCount];
            roster1player3User = new String[matchTypeCount];
            roster2player1User = new String[matchTypeCount];
            roster2player2User = new String[matchTypeCount];
            roster2player3User = new String[matchTypeCount];
            resultMatch1 = new Boolean[matchTypeCount];
            resultMatch2 = new Boolean[matchTypeCount];
            player11 = new UserPlayer[matchTypeCount];
            player12 = new UserPlayer[matchTypeCount];
            player13 = new UserPlayer[matchTypeCount];
            parti11 = new Participant[matchTypeCount];
            parti12 = new Participant[matchTypeCount];
            parti13 = new Participant[matchTypeCount];
            player21 = new UserPlayer[matchTypeCount];
            player22 = new UserPlayer[matchTypeCount];
            player23 = new UserPlayer[matchTypeCount];
            parti21 = new Participant[matchTypeCount];
            parti22 = new Participant[matchTypeCount];
            ...
            for (i = 0; i < matchTypeCount; i++) {

                // Get match summary
                matchID[i] = matchesArr.getJSONObject(pos.get(i)).getString("id");
                rawCreatedAt[i] = matchesArr.getJSONObject(pos.get(i)).getJSONObject("attributes").getString("createdAt");
            ...
            for (int z = 0; z < matchTypeCount; z++){
